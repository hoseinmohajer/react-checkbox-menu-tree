...
import { Container, Header, Title, IconContainer, Icon, MenuTreeWrapper, TreeMenuTitle } from './style';
								...
								<div className="right-side">
									...
									<TreeMenuTitle
										width={Number(
											Math.random()
												.toString()
												.substring(Math.random().toString().length, Math.random().toString().length - 2)
										)}
									/>
								</div>
							</li>
